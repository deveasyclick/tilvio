      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
          <img
            ...
            src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/products/apple-watch.png"
            alt="Product image"
          />
          <div className="p-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
          <img
            className="w-full h-48 object-cover"
            src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/products/imac.png"
            alt="Product image"
          />
          <div className="p-4">
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
              Apple iMac 27" 5K Retina Display M1 Processor
            </h5>
            <div className="flex items-center mt-2.5 mb-5">
              <svg
                className="w-4 h-4 text-yellow-300 mr-1"
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
          <img
            className="w-full h-48 object-cover"
            src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/products/iphone-x.png"
            alt="Product image"
          />
          <div className="p-4">
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
