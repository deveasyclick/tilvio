...
var manufacturerRanges = map[string][]CodeRange{
	"Goodwill": {
		...
		{Min: 40000, Max: 40999, Description: "vitrified", Type: "floor", WeightInKg: 27.5, Dimension: "400X400"},
		{Min: 40100, Max: 40179, Description: "glazed", Type: "floor", WeightInKg: 27.5, Dimension: "400X400"},
		...
		{Min: 66000, Max: 66199, Description: "super polished", Type: "floor", WeightInKg: 31, Dimension: "600X600"},
