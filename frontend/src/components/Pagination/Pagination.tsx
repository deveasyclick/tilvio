...
const Pagination: React.FC<PaginationProps> = ({
  ...
  const buttonStyles = useMemo(
    () => ({
      mobile: {
        base: 'relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700 mr-0 cursor-pointer',
      },
      desktop: {
        base: 'relative inline-flex items-center text-sm font-semibold ring-1 ring-inset ring-gray-300 focus:z-20 focus:outline-offset-0 dark:ring-gray-600 mr-0 p-0 cursor-pointer',
        active:
